...
while(currentLocation!=winDestination){
	switch(currentLocation){
		...
		case "house":
			alert(houseMessage);
			response = prompt("Where would you like to go next? or would you like to \"enter the house?\"");
			if(response=="go east"){
				currentLocation = "forest";
			} else if(response=="go south") {
				currentLocation = "pond";
			} else if(response=="enter the house") {
				currentLocation = "in_House";
			}
		break;
		
		case "pond":
			alert(pondMessage);
			response = prompt("Where would you like to go next? or \"drink the water\"");
		...
		case "clearing":
			...
			response = prompt("Where else would you like to go next?");
			if(response=="go north"){
				currentLocation = "forest";
